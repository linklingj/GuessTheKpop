document.addEventListener("DOMContentLoaded", () => {
    ...
    const endText = [["와! 케이팝 고인물이시네요!","이 노래를 안다고??","오~ 좀 하네","운이 좋은거 아냐?","한번 더해도 이렇게 잘할까"],["나쁘지 않네","다음에는 한번에 맞추길!","아니~ 이 노래는 한번에 맞춰야지","좀 하네ㅋ"],["실망이 크다","그래도 새로운 노래 하나 배워가네ㅎ","아 이 노래는 알 줄 알았는데","케이팝 초보시군요!"]];
    let tries = 1;
    let guesses = [];
